...
function getCurrentHotel(hotels) {
  return hotels.find((hotel) => window.location.pathname.endsWith(`/${hotel.id}`));
}

export default function RoomPage({ hotels }) {
  const currentHotel = getCurrentHotel(hotels);

  if (!currentHotel) {
    return <Redirect to='/error' />;
  }

  const { isFavorite, isPremium, price, rating, title, type, goods, bedrooms, images, maxAdults } = currentHotel;
